...
// The Windows port breaks atomic ops out into a public header, because I want to use atomic ops in dispatch++,
// but standard libdispatch doesn't. This is an ugly copy-and-paste.
